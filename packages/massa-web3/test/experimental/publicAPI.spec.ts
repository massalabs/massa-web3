...
describe('unit tests', () => {
  ...
  test('getGraphInterval', async () => {
    ...
    GraphInterval.strictCheck(interval)
  })
  ...
  test('getSlotTransfers', async () => {
    ...
    Transfers.strictCheck(transfers)
  })
  ...
  test('getMultipleSlotTransfers', async () => {
    ...
    transfersArray.forEach((t) => Transfers.strictCheck(t))
  })
  ...
  test('getMultipleEndorsements', async () => {
    ...
    endorsements.forEach((e) => EndorsementChecker.strictCheck(e))
  })
