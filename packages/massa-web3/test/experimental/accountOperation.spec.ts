...
describe('Basic use cases', () => {
    test('AccountOperation - transfer', async () => {
        ...
        const client = new PublicAPI(Transport.https, 'buildnet.massa.net', 443, '/api/v2')
        const accountOperation = new AccountOperation(account, client)
        const transfer = await accountOperation.transfer('AU1wN8rn4SkwYSTDF3dHFY4U28KtsqKL1NnEjDZhHnHEy6cEQm53', 1)
