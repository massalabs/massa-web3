...
class BlockHeader$Type extends MessageType<BlockHeader> {
    ...
    create(value?: PartialMessage<BlockHeader>): BlockHeader {
        ...
        message.parents = [];
        message.operationsHash = "";
        message.endorsements = [];
        message.denunciations = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated massa.model.v1.SignedEndorsement endorsements */ 6:
                    ...
                    break;
                case /* repeated massa.model.v1.Denunciation denunciations */ 7:
                    message.denunciations.push(Denunciation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: BlockHeader, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated massa.model.v1.Denunciation denunciations = 7; */
        for (let i = 0; i < message.denunciations.length; i++)
            Denunciation.internalBinaryWrite(message.denunciations[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
