...
class NodeStatus$Type extends MessageType<NodeStatus> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* massa.model.v1.CompactConfig config */ 16:
                    ...
                    break;
                case /* uint64 chain_id */ 17:
                    message.chainId = reader.uint64().toBigInt();
                    break;
                case /* uint32 current_mip_version */ 18:
                    message.currentMipVersion = reader.uint32();
                    break;
                default:
    ...
    internalBinaryWrite(message: NodeStatus, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.chainId !== 0n)
            writer.tag(17, WireType.Varint).uint64(message.chainId);
        /* uint32 current_mip_version = 18; */
        if (message.currentMipVersion !== 0)
            writer.tag(18, WireType.Varint).uint32(message.currentMipVersion);
...
class CompactConfig$Type extends MessageType<CompactConfig> {
    ...
    create(value?: PartialMessage<CompactConfig>): CompactConfig {
        ...
        message.deltaF0 = 0n;
        message.operationValidityPeriods = 0n;
        message.periodsPerCycle = 0n;
        message.maxBlockSize = 0;
        if (value !== undefined)
...
class PublicStatus$Type extends MessageType<PublicStatus> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* massa.model.v1.CompactConfig config */ 11:
                    message.config = CompactConfig.internalBinaryRead(reader, reader.uint32(), options, message.config);
                    break;
                case /* uint64 chain_id */ 12:
                    message.chainId = reader.uint64().toBigInt();
                    break;
                case /* massa.model.v1.NativeAmount minimal_fees */ 13:
                    message.minimalFees = NativeAmount.internalBinaryRead(reader, reader.uint32(), options, message.minimalFees);
                    break;
                case /* uint32 current_mip_version */ 14:
                    message.currentMipVersion = reader.uint32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: PublicStatus, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint64 chain_id = 12; */
        if (message.chainId !== 0n)
            writer.tag(12, WireType.Varint).uint64(message.chainId);
        /* massa.model.v1.NativeAmount minimal_fees = 13; */
        if (message.minimalFees)
            NativeAmount.internalBinaryWrite(message.minimalFees, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        /* uint32 current_mip_version = 14; */
        if (message.currentMipVersion !== 0)
            writer.tag(14, WireType.Varint).uint32(message.currentMipVersion);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
