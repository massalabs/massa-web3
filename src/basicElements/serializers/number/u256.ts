 ...
 */
export function toBytes(value: U256_t): Uint8Array {
 ...
 */
export function fromBytes(bytes: Uint8Array): U256_t {
 ...
 */
export function fromNumber(value: number | bigint): U256_t {
