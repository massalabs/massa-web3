 ...
 */
export function toBytes(value: I64_t): Uint8Array {
 ...
 */
export function fromBytes(bytes: Uint8Array): I64_t {
 ...
 */
export function fromNumber(value: number | bigint): I64_t {
