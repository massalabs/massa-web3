 ...
 */
export function toBytes(value: I16_t): Uint8Array {
 ...
 */
export function fromBytes(bytes: Uint8Array): I16_t {
 ...
 */
export function fromNumber(value: number): I16_t {
