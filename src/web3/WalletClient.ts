...
export class WalletClient extends BaseClient implements IWalletClient {
	...
	public async sendTransaction(txData: ITransactionData, executor?: IAccount): Promise<Array<string>> {
	  ...
	  // bytes compaction
	  const bytesCompact: Buffer = this.compactBytesForOperation(txData, OperationTypeId.Transaction, expiryPeriod);
	...
	public async buyRolls(txData: IRollsData, executor?: IAccount): Promise<Array<string>> {
	  ...
	  // bytes compaction
	  const bytesCompact: Buffer = this.compactBytesForOperation(txData, OperationTypeId.RollBuy, expiryPeriod);
	...
	public async sellRolls(txData: IRollsData, executor?: IAccount): Promise<Array<string>> {
	  ...
	  // bytes compaction
	  const bytesCompact: Buffer = this.compactBytesForOperation(txData, OperationTypeId.RollSell, expiryPeriod);
