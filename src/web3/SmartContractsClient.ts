...
export class SmartContractsClient extends BaseClient implements ISmartContractsClient {
  ...
  public async deploySmartContract(contractData: IContractData, executor?: IAccount): Promise<string> {
    ...
    // bytes compaction
    const bytesCompact: Buffer = this.compactBytesForOperation(contractData, OperationTypeId.ExecuteSC, expiryPeriod);
  ...
  public async callSmartContract(callData: ICallData, executor?: IAccount): Promise<string> {
    ...
    // bytes compaction
    const bytesCompact: Buffer = this.compactBytesForOperation(callData, OperationTypeId.CallSC, expiryPeriod);
