...
interface IMassaService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  createOrderbook: IMassaService_IcreateOrderbook;
  deleteOrderbook: IMassaService_IdeleteOrderbook;
}

interface IMassaService_IcreateOrderbook
  extends grpc.MethodDefinition<
    protos_massaservice_pb.CreateOrderbookRequest,
    protos_massaservice_pb.CreateOrderbookResponse
  > {
...
interface IMassaService_IdeleteOrderbook
  extends grpc.MethodDefinition<
    protos_massaservice_pb.DeleteOderbookRequest,
    protos_massaservice_pb.DeleteOrderbookResponse
  > {
...
export interface IMassaClient {
  createOrderbook(
    request: protos_massaservice_pb.CreateOrderbookRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: protos_massaservice_pb.CreateOrderbookResponse,
    ) => void,
  ...
  deleteOrderbook(
    request: protos_massaservice_pb.DeleteOderbookRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: protos_massaservice_pb.DeleteOrderbookResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  deleteOrderbook(
    request: protos_massaservice_pb.DeleteOderbookRequest,
