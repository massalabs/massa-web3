...
goog.provide('proto.massa.api.v1.ExecuteSC');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.massa.api.v1.BytesMapFieldEntry');
 ...
 * @const
 */
proto.massa.api.v1.ExecuteSC.repeatedFields_ = [3];
...
proto.massa.api.v1.ExecuteSC.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.massa.api.v1.BytesMapFieldEntry.toObject, includeInstance)
  };
...
proto.massa.api.v1.ExecuteSC.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.massa.api.v1.BytesMapFieldEntry;
      reader.readMessage(value,proto.massa.api.v1.BytesMapFieldEntry.deserializeBinaryFromReader);
...
proto.massa.api.v1.ExecuteSC.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.massa.api.v1.BytesMapFieldEntry.serializeBinaryToWriter
    );
  }
};
...
proto.massa.api.v1.ExecuteSC.prototype.getDatastoreList = function() {
  return /** @type{!Array<!proto.massa.api.v1.BytesMapFieldEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.massa.api.v1.BytesMapFieldEntry, 3));
};
