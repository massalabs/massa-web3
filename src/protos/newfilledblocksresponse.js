...
goog.provide('proto.massa.api.v1.NewFilledBlocksResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.massa.api.v1.FilledBlock');
...
proto.massa.api.v1.NewFilledBlocksResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    filledBlock: (f = msg.getFilledBlock()) && proto.massa.api.v1.FilledBlock.toObject(includeInstance, f)
  };
...
proto.massa.api.v1.NewFilledBlocksResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.massa.api.v1.FilledBlock;
      reader.readMessage(value,proto.massa.api.v1.FilledBlock.deserializeBinaryFromReader);
...
proto.massa.api.v1.NewFilledBlocksResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.massa.api.v1.FilledBlock.serializeBinaryToWriter
    );
  }
};
...
proto.massa.api.v1.NewFilledBlocksResponse.prototype.getFilledBlock = function() {
  return /** @type{?proto.massa.api.v1.FilledBlock} */ (
    jspb.Message.getWrapperField(this, proto.massa.api.v1.FilledBlock, 2));
};
