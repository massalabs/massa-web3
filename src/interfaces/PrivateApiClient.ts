...
export interface PrivateApiClient {
  /**
   * Method to ban a node by its D.
   *
   * @param id - The D of the node to ban.
   *
  ...
  /**
   * Method to ban a node by its P address.
   *
   * @param ipAddress - The P address of the node to ban.
   *
   * @returns - A promise so that the call can be asynchronous.
   */
  ...
  /**
   * Method to unban a node by its D.
   *
   * @param nodeId - The D of the node to unban.
   *
   * @returns - A promise so that the call can be asynchronous.
   */
  ...
  /**
   * Method to unban a node by its P address.
   *
   * @param ipAddress - The P address of the node to unban.
   *
   * @returns - A promise so that the call can be asynchronous.
   */
   ...
   *
   * @param ipAddress - The P address of the node to remove from the whitelist.
   *
   * @returns - A promise so that the call can be asynchronous.
   */
   ...
   *
   * @param ipAddress - The P address of the node to add to the whitelist.
   *
   * @returns - A promise so that the call can be asynchronous.
   */
   ...
   */
  nodeSignMessage(message: Uint8Array): Promise<SignedMessage>;
