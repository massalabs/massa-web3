 ...
 *
 * @see id of type `string` represents the D of the endorsement.
 * @see in_pool of type `boolean` represents whether the endorsement is in the mempool.
 * @see in_blocks of type `Array<string>` represents the Ds of the blocks that contain the endorsement.
 ...
 * @see endorsement.content.slot of type `Slot` represents the time slot when the endorsement was created.
 * @see endorsement.content.index of type `number` represents the index of the endorsement inside the slot.
 * @see endorsement.content.endorsed_block of type `string` represents the D of the block that was endorsed.
