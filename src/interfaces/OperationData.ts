 ...
 *
 * @remarks
 * This interface is used to track the details of an operation, including its D, associated block Ds,
 * presence in the transaction pool, finality status, thread, operation content, and execution status.
 *
 * @see id - A string representing the D of the operation.
 * @see in_blocks - An array of strings representing the associated block Ds.
