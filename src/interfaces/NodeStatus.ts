 ...
 * @see last_slot of type `Slot` represents the last slot of the node.
 * @see network_stats of type `object` represents the network statistics of the node.
 * @see next_slot of type `Slot` represents the next slot of the node.
 * @see node_id of type `string` represents the D of the node.
