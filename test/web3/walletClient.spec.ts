...
import { FullAddressInfo } from '../../src/interfaces/FullAddressInfo';
import { RollsData } from '../../src/interfaces/RollsData';
...
describe('WalletClient', () => {
  ...
  describe('walletInfo', () => {
    ...
    test('should return IFullAddressInfo objects that include information from the corresponding IAddressInfo', async () => {
      ...
      const mockAddressInfo: FullAddressInfo[] = [
