    ...
    compactBytesForOperation(data, opTypeId, account, expirePeriod) {
        ...
        switch (opTypeId) {
            case OperationTypes_1.OperationTypeId.ExecuteSC: {
                ...
                return buffer_1.Buffer.concat([publicKeyEncoded, feeEncoded, expirePeriodEncoded, typeIdEncoded, maxGasEncoded, coinsEncoded, gasPriceEncoded, dataLengthEncoded, contractDataEncoded]);
            }
            case OperationTypes_1.OperationTypeId.CallSC: {
                ...
                return buffer_1.Buffer.concat([publicKeyEncoded, feeEncoded, expirePeriodEncoded, typeIdEncoded, maxGasEncoded, parallelCoinsEncoded, sequentialCoinsEncoded, gasPriceEncoded, targetAddressEncoded, functionNameLengthEncoded, functionNameEncoded, parametersLengthEncoded, parametersEncoded]);
            }
            case OperationTypes_1.OperationTypeId.Transaction: {
                ...
                return buffer_1.Buffer.concat([publicKeyEncoded, feeEncoded, expirePeriodEncoded, typeIdEncoded, recipientAddressEncoded, transferAmountEncoded]);
            }
            ...
            case OperationTypes_1.OperationTypeId.RollSell: {
                ...
                return buffer_1.Buffer.concat([publicKeyEncoded, feeEncoded, expirePeriodEncoded, typeIdEncoded, rollsAmountEncoded]);
            }
        }
    }
}
