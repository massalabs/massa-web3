...
export declare class PublicAPI {
    ...
    getAddressesBytecode(addressFilter: AddressFilter): Promise<number[]>;
    executeMultipleGetAddressesBytecode(addressFilters: AddressFilter[]): Promise<number[][]>;
    ...
    getDatastoreEntries(inputs: DatastoreEntry[], final?: boolean): Promise<string[]>;
    getDatastoreEntry(key: string | Uint8Array, address: string, final?: boolean): Promise<string[] | string>;
    ...
    getCurrentSlot(): Promise<Slot | undefined>;
